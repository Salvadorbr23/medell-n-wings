...
const FEATURES = [
  ...
  { icon: MapPin, label: "San Félix, Km 6 vía Medellín – San Pedro. Recogemos en tu hotel" },
];
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-5xl mx-auto items-center">
          ...
          <div className="rounded-2xl overflow-hidden shadow-lg aspect-[4/3]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3966.1!2d-75.585!3d6.345!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e4428dfb80fad05%3A0x42137cfcc7b53b56!2sSan+F%C3%A9lix!5e0!3m2!1ses!2sco!4v1700000000000"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Ubicación despegue San Félix, Km 6 vía Medellín - San Pedro"
            />
          </div>
          ...
          <div>
            <p className="text-foreground/80 text-lg mb-4">
              <a
                href="https://maps.app.goo.gl/iCEygie5nVEjtq4u7?g_st=iw"
                target="_blank"
                rel="noopener noreferrer"
                className="text-primary font-bold hover:underline"
              >
                📍 Despegue: San Félix, Kilómetro 6 vía Medellín – San Pedro
              </a>
            </p>
